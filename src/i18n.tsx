...
const translations = {
  en: {
    ...
    "Install yt-dlp to improve parsing for dynamic video sites.": "macOS and Windows builds include yt-dlp for dynamic video sites. Built-in parsing remains available for direct links.",
    ...
    "Check GitHub Releases when Intervox starts. Installation always requires confirmation.": "Check GitHub Releases when Intervox starts. Installation always requires confirmation.",
    "Checking for updates...": "Checking for updates...",
    "Check for updates": "Check for updates",
    "Update available": "Update available",
    "Intervox is up to date.": "Intervox is up to date.",
    "No update check has been run yet.": "No update check has been run yet.",
    "View update": "View update",
    "Intervox update available": "Intervox update available",
    "Close update dialog": "Close update dialog",
    "Release notes": "Release notes",
    "No changelog provided.": "No changelog provided.",
    "Skip this version": "Skip this version",
    "Download and install": "Download and install",
    "Downloading update...": "Downloading update...",
    "Update installed. Restart Intervox to finish.": "Update installed. Restart Intervox to finish.",
    "Restart now": "Restart now",
    "Update checks are only available in the installed desktop app.": "Update checks are only available in the installed desktop app.",
    "Finish or cancel all queued and running tasks before installing an update.": "Finish or cancel all queued and running tasks before installing an update.",
  },
  zh: {
    // 侧边栏及常规
    "Player": "播放器",
    ...
    "Install yt-dlp to improve parsing for dynamic video sites.": "macOS 和 Windows 版本已内置 yt-dlp，可解析动态视频网站；媒体直链仍会使用内置解析器。",
    ...
    "Automatically check for updates": "启动时自动检查更新",
    "Check GitHub Releases when Intervox starts. Installation always requires confirmation.": "Intervox 启动时检查 GitHub Releases；下载和安装始终需要用户确认。",
    "Checking for updates...": "正在检查更新……",
    "Check for updates": "检查更新",
    "Update available": "发现新版本",
    "Intervox is up to date.": "Intervox 已是最新版本。",
    "No update check has been run yet.": "尚未执行更新检查。",
    "View update": "查看更新",
    "Intervox update available": "发现 Intervox 新版本",
    "Close update dialog": "关闭更新窗口",
    "Release notes": "更新说明",
    "No changelog provided.": "本次更新未提供变更说明。",
    "Skip this version": "跳过此版本",
    "Download and install": "下载并安装",
    "Downloading update...": "正在下载更新……",
    "Update installed. Restart Intervox to finish.": "更新已安装，重启 Intervox 后生效。",
    "Restart now": "立即重启",
    "Update checks are only available in the installed desktop app.": "只有已安装的桌面版 Intervox 可以检查更新。",
    "Finish or cancel all queued and running tasks before installing an update.": "安装更新前，请先完成或取消所有排队中和运行中的任务。",
  }
};
